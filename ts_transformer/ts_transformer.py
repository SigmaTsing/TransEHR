...
class TSTransformerEncoder(nn.Module):
    ...
    def __init__(self, feat_dim, max_len, d_model, n_heads, num_layers, dim_feedforward, dropout=0.1,
        ...
        # self.encoder_output = nn.Linear(d_model, feat_dim)
    ...
    def forward(self, X, padding_masks):
        ...
        # * math.sqrt(self.d_model)  # [seq_length, batch_size, d_model] project input vectors to d_model dimensional space
        ...
        # output = self.encoder_output(output)  # (batch_size, seq_length, feat_dim)
...
class TSTransformerEncoderClassiregressor(nn.Module):
    ...
    def __init__(self, feat_dim, max_len, d_model, n_heads, num_layers, dim_feedforward, num_classes,
                 dropout=0.1, pos_encoding='fixed', activation='gelu', norm='BatchNorm', freeze=False, aggregation = 'max'):
...
class MaskedLanguageModel(nn.Module):
    def __init__(self, encoder, d_model, feat_dim, aggr = 'max'):
        super(MaskedLanguageModel, self).__init__()

        self.output_head = nn.Linear(d_model, feat_dim)
